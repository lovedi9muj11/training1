...
public class FirstPdf {
	...
	public void addTitlePage(Document document) throws DocumentException, IOException {
		...
		BaseFont courier = BaseFont.createFont("/fonts/THSarabunNew.ttf",
                BaseFont.IDENTITY_H, BaseFont.EMBEDDED);
		catFont = new Font(courier, 18, Font.BOLD);
		redFont = new Font(courier, 18, Font.NORMAL, BaseColor.RED);
		subFont = new Font(courier, 16, Font.BOLD);
		...
		preface.add(new Paragraph(
				"This document is a สวัสดี  preliminary version and not subject to your license agreement or any other agreement with vogella.com ;-).",
				redFont));
